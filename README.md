...
- Do not manually edit files inside `/dashboard` (See below for exception)

---

## elevation.json

The file below contains landmark elevation data used by the dashboard:

`dashboard/elevation.json`

It is used for the Elevation comparison stats (e.g. *"You've climbed higher than..."* and *"Next target..."*).

**Note:** This file is currently UK/Britain-focused, as the project was originally built for personal use.

It includes:
- Top 100 British buildings
- Top 100 British mountains
- Top 100 world buildings
- Top 100 world mountains

### Customising / Localising

You can add your own landmarks (mountains/buildings/etc.) to localise it to your own country or region.
